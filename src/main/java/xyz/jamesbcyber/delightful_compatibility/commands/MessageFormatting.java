...
public class MessageFormatting {
     ...
     */
    public static void sendClickToCopyMessage(ServerPlayer player, String contentToCopy) {
     ...
     * @param contentToCopy The text content that will be copied to the clipboard.
     */
    public static void sendHyperlinkClickToCopyMessage(ServerPlayer player, String contentToCopy) {
        MutableComponent message = Component.literal("Click here")
                .withStyle(style -> style
     ...
     */
    public static void sendOpenLogFileMessage(ServerPlayer player, String filePath, String text) {
